...
export default function trackList({
  ...
  return (
    <>
      ...
      <table className="w-full table-fixed text-left font-semibold">
        <thead className="bg-black text-lg uppercase text-white">
          <tr>
        ...
        <tbody className="px-4 py-1 text-base before:block before:h-3 after:block after:h-3 md:text-lg">
