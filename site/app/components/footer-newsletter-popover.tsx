        ...
        >
          ...
          <div className="px-9 py-1.5 md:py-3">
            ...
            <input
              ...
              autoCorrect="off"
              required
              className="md:text-oxe-xl/[3.875rem] form-input h-10 w-full border-0 text-oxe-sm/10 ring-0 placeholder:text-[#7B7878] focus:ring-0 focus:ring-offset-0 md:h-[3.875rem]"
              type="email"
              placeholder="Email"
              name="email"
            />
