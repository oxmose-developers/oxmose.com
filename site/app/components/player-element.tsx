...
function PlayerNowPlaying() {
  ...
  return (
    <div className="text-oxe-xxs relative flex flex-1 items-center justify-between gap-4 overflow-x-hidden px-5 uppercase leading-[inherit] md:text-oxe-xs">
  ...
  return (
    <div className="max-h-[calc(100svh/2)] overflow-y-scroll border-t-hairline border-white/40 bg-black text-white">
      <div className="grid divide-y-hairline divide-white/40">
        <div className="text-oxe-xxs relative grid grid-cols-2 gap-x-5 px-5 py-1.5 leading-[inherit] md:grid-cols-3 md:text-oxe-xs">
        ...
        {state.playlist.map((track, index) => (
          <div
            key={track.title}
            className="text-oxe-xxs relative grid grid-cols-[1fr_auto] gap-x-5 px-5 py-1.5 leading-[inherit] hover:bg-white hover:text-black data-[current-track=true]:bg-oxe-purple data-[current-track=true]:text-black md:grid-cols-3 md:text-oxe-xs"
